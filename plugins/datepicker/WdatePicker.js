...
function Datepicker(elements, options) {
    elements.unbind('mousedown.datepicker')
        .bind('mousedown.datepicker', function () {
            WdatePicker($.extend({el:this}, {dateFmt:$(this).attr('format')}, options));
        });
};
