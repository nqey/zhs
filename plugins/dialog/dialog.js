define([
    'plugins/zepto/zepto.min',
    'css!plugins/dialog/dialog.css'
], function () {
    /*  
    ...
    */  
    ...
    TipBox.prototype.renderUI = function(tipType){   
        ...
        tipType != 'load' && this.config.setTime && setTimeout( function(){ _this.close(); }, _this.config.setTime );  
    };  
    ...
    TipBox.prototype.loadRenderUI = function(){  
        ...
        // load += "  <div class='bounce1'></div>";  
        // load += "  <div class='bounce2'></div>";  
        // load += "  <div class='bounce3'></div>";  
        // load += " </div>";  
    ...
    return {
        createTipBox : function(cfg) {
            return new TipBox(cfg);
        }
    }
});
